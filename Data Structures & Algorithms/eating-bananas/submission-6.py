...
# Tricks :  
   ...
   # B.  put l & r on the lowest and highest possible answers. Use mid as a test answer. If mid passes, try a slower answer on the left. If it fails, look for a larger answer on the right.
