...
# Optimal Solution
    ...
    # Approach:  DP is remembering past results to build the next one, I'll init the base case and dp array/dp varaible to  remember each position's maximum profit, traverse the array with the transitions formula, and return the final result
    # Tricks:
