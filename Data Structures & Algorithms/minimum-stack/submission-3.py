...
# Image :Sync a min-stack to to track the minimum value at every step  with the main stack to track all elements
    ...
    def push(self, val:int)->None:
        ...
        if not self.min_stack:
            ...
            if val < currentMin:
                ...
                self.min_stack.append(currentMin) #為了同步2個stack長度
...
def test():
    ...
    minstack.push(2)
    minstack.push(0)
    minimum = minstack.getMin()  # return 0
    minstack.pop()
    top = minstack.top()
