...
#B.Design the data structure : 
    ...
    # when we push new element into data_stack , compare new element with Auxiliary stack top, push the smaller element into Auxiliary stack
    ...
    def push(self, val:int)->None:
        ...
        if not self.min_stack:
            ...
            if val < current_minimum:
                ...
                self.min_stack.append(current_minimum) #為了同步2個stack長度
