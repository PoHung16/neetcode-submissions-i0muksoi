class Solution:
    def minWindow(self, s: str, t: str) -> str:
        # 題型Keyword: 題目提到「substring」 -> Sliding Window (Variable) 2 Map
        ...
        for end in range(len(s)):
            ...
            char = s[end]
            window_map[char] = window_map.get(s[end], 0) + 1
            if s[end] in target_map and window_map[char] == target_map[char]:
                have += 1
