"""
 ...
 output : int
"""
# Keyword : “Two heaviest stones”, “Most Frequent Element Cooldown Period” -> Heap Process Simulation (deal with all element in heap)
# Image: Prcoess all element with heap operation
# Tricks:
