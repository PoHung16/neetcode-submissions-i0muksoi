...
# Optimal Solution
    ...
    # Approach: Define a DFS function to build permutations. At each level, loop through all elements in nums. If an element hasn't been used yet, pick it, mark it as used, and move to the next position.
    # Tricks - DFS
