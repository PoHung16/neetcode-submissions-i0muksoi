class Solution:
    def countComponents(self, n: int, edges: List[List[int]]) -> int:
        ...
        if n == 0: 
            return 0
        #ps.Decide if its’ a matrix or adjacent graph -> adjacent graph
        ...
        def dfs(i):
            ...
            #2-b Every Layer：consider all neighbor directions , if not visited- Mark & Move
            visited.add(i)
...
# Space complexity:  O(V+E).... cwe have V 個dfs  but create size V+E graph since its undirected
